...
public class TestOrders {
    public static void main(String[] args) {
        ...
        Order order4 = new Order("Chelsea");
        Order order5 = new Order("Violet");


        //Add at least 2 items to each of the orders using the addItem method you wrote, 
        //for example, to add item1 to order3 you would need to call the 
        //addItem method from the order3 instance like so: order3.addItem(item1);
